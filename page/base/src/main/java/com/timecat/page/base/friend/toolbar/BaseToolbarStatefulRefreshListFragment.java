 ...
 * @date 2020/11/25
 * @description Theme -> Event -> LazyLoad -> Simple -> List -> Refresh -> Stateful -> Toolbar
 * @usage null
 */
public abstract class BaseToolbarStatefulRefreshListFragment extends BaseStatefulRefreshListFragment
