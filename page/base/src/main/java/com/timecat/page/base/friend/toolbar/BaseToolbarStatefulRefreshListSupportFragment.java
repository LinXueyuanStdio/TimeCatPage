 ...
 * @date 2020/11/25
 * @description Theme -> Event -> LazyLoad -> Simple -> List -> Refresh -> Stateful -> Support -> Toolbar
 * @usage null
 */
public abstract class BaseToolbarStatefulRefreshListSupportFragment extends BaseToolbarStatefulRefreshListFragment implements ISupportFragment {
    final SupportFragmentDelegate mDelegate = new SupportFragmentDelegate(this);
    protected BaseSupportActivity _mActivity;
    ...
    public void onAttach(Activity activity) {
        ...
        _mActivity = (BaseSupportActivity) mDelegate.getActivity();
    }
