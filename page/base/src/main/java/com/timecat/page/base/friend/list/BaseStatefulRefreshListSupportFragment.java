 ...
 * @date 2020/5/24
 * @description Theme -> Support -> Event -> LazyLoad -> Simple -> List -> Refresh -> Stateful
 * @usage StatefulLayout : R.id.ll_stateful
 */
public abstract class BaseStatefulRefreshListSupportFragment extends BaseRefreshListSupportFragment {
